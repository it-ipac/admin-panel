...
function CountBadge({ count }: { count: number | undefined }) {
	...
	return (
		<span className="ml-1.5 inline-flex items-center justify-center w-4 h-4 rounded-full bg-primary-600 text-white text-[10px] font-semibold leading-none">
			{count > 99 ? "99+" : count}
		</span>
	);
}
...
export function RequestsPage() {
	...
	return (
		<div className="flex-1 flex flex-col min-h-0 bg-neutral-50">
			{/* Page header */}
			<div className="px-8 pt-8 pb-4 bg-white border-b border-neutral-200">
			...
			{/* Tabs */}
			<div className="px-8 bg-white border-b border-neutral-200">

		...
		<div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden">
			...
			<div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 p-8 relative z-10">
				<div className="text-center mb-10">
					...
					<h1 className="text-2xl font-bold text-gray-900 tracking-tight">IPAC Secure Portal</h1>
					<p className="text-gray-500 text-sm mt-2 font-medium">Log in to track your items and packages.</p>
				</div>
				...
				<div className="mt-8 text-center border-t border-gray-100 pt-6">
					<p className="text-xs text-gray-400 font-medium">Powered by IPAC Global Packaging</p>
				</div>
			</div>
		</div>
	);

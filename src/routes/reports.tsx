			...
			<main className="flex-1 overflow-y-auto">
				<div className="p-8 max-w-7xl mx-auto">
					<div className="flex justify-between items-center mb-8">
						...
						<div className="flex items-center space-x-3 bg-gray-200 p-1 rounded-lg">
							<button
								onClick={() => setActiveTab("analytics")}
								className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === "analytics" ? "bg-white shadow text-blue-600" : "text-gray-600 hover:text-gray-900"}`}
							>
								Analytics
							</button>
							<button
								onClick={() => setActiveTab("builder")}
								className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === "builder" ? "bg-white shadow text-blue-600" : "text-gray-600 hover:text-gray-900"}`}
							>
								Report Builder
							</button>
						</div>
								...
								{!analytics ? (
									<div className="h-full flex flex-col items-center justify-center bg-white rounded-xl border border-dashed border-gray-300 py-20 px-6 text-center">
										...
										<p className="text-gray-500 max-w-xs mt-1">
											Select a client and at least one project from the sidebar
											to view the report.
										</p>
									</div>
								) : (

...
function ReportsPage() {
	...
	const [activeTab, setActiveTab] = useState<"analytics" | "builder">(
		"builder",
	);
				...
				<div className="p-8 max-w-7xl mx-auto">
					<div className="flex justify-between items-center mb-8">
						<div>
							...
							<p className="text-neutral-500 mt-1">
								Select clients and projects to view packing performance or
								generate reports.
							</p>
						</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
							...
							<div className="bg-white rounded-xl shadow-sm border border-neutral-100 p-6">
								...
								{selectedClientId && (
									<div className="space-y-4">
										...
										<div className="max-h-[300px] overflow-y-auto border border-neutral-100 rounded-lg p-2 bg-neutral-50">
											{ordersLoading ? (
						...
						<div className="lg:col-span-2 space-y-6">
							{!analytics ? (
								<div className="h-full flex flex-col items-center justify-center bg-white rounded-xl border border-dashed border-neutral-300 py-20 px-6 text-center">
								...
								<>
									...
									<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
										<div className="bg-white p-6 rounded-xl shadow-sm border border-neutral-100 flex items-center space-x-4">
											<div className="p-4 bg-iris-100 rounded-xl">
												<Package className="w-8 h-8 text-iris-600" />
											</div>
											<div>
										...
										<div className="bg-white p-6 rounded-xl shadow-sm border border-neutral-100 flex items-center space-x-4">
											<div className="p-4 bg-success-100 rounded-xl">
												<Hash className="w-8 h-8 text-success-600" />
											</div>
											<div>
												<p className="text-sm font-medium text-neutral-500 uppercase tracking-wider">
													Total Quantity
											...
											<table className="w-full text-left">
												<thead>
													<tr className="bg-neutral-50">
														...
														<th className="px-6 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider text-center">
															Items
														</th>
														<th className="px-6 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider text-center">
															Total Qty

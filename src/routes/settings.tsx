...
import { Loader2, User, Bell, Shield, Palette, Save, Check } from 'lucide-react'
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input type="password" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                      </div>
                      <div>
                ...
                <div className="space-y-6 max-w-2xl">
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      >
                        <div className="w-full h-20 bg-gradient-to-b from-white to-gray-900 rounded-lg mb-2"></div>

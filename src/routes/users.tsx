		...
		<div className="flex h-screen bg-gray-50">
						...
						<section>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
								{packerAssignmentsLoading ? (
									<div className="col-span-full py-8 flex items-center gap-2 text-gray-600 justify-center">
										<Loader2 className="w-4 h-4 animate-spin" />
										Loading available packers...
									</div>
								) : packerAssignmentsError ? (
									<div className="col-span-full py-4 text-center text-red-600 bg-red-50 rounded-lg">
									...
									packerAssignments
										...
										.map((p) => (
											<div
												key={p.packer_id}
												className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 group"
											>
												...
												<button
													...
													className="w-full py-2 bg-blue-50 text-blue-600 text-xs font-bold rounded-lg hover:bg-blue-600 hover:text-white transition-all flex items-center justify-center gap-1.5"
												>
											...
											>
												<div className="px-6 py-4 bg-gray-50/50 border-b border-gray-200 flex items-center justify-between">
													<div className="flex items-center gap-4">
														...
														<div className="flex items-center gap-2 border-l border-gray-200 pl-4">
															<button
																...
																className="flex items-center gap-1 px-3 py-1 bg-blue-50 text-blue-600 text-[10px] font-bold rounded-lg hover:bg-blue-100 transition-colors"
															>
															...
															<button
																...
																className="flex items-center gap-1 px-3 py-1 bg-red-50 text-red-600 text-[10px] font-bold rounded-lg hover:bg-red-100 transition-colors"
															>
													...
													<button
														...
														className="text-xs text-blue-600 font-bold hover:text-blue-700 flex items-center gap-1 transition-colors"
													>
														...
														>
															<div className="flex items-center gap-3">
																<div className="relative">
																	...
																	{member.is_team_lead && (
																		<div className="absolute -top-1 -right-1 bg-amber-400 text-white p-0.5 rounded-full ring-2 ring-white">
																...
																<div>
																	<p className="text-sm font-bold text-gray-900 flex items-center gap-2">
																		...
																		{member.is_team_lead && (
																			<span className="text-[9px] bg-amber-50 text-amber-600 px-1.5 py-0.5 rounded border border-amber-100 uppercase font-extrabold tracking-tight">
																				Lead
																			</span>
																		)}
																	</p>
															...
															<div className="flex items-center gap-1">
																<button
																	...
																	className="p-2 text-slate-400 hover:text-orange-500 hover:bg-orange-50 rounded-lg transition-colors group"
			...
			{assigningPacker && (
				...
				>
					<Dialog.Portal>
						...
						<Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 z-[70] border border-gray-100">
							...
							<div className="space-y-2">
								...
								<div className="relative">
									<select
										...
										className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all appearance-none cursor-pointer text-sm font-medium pr-10"
									>
							...
							<div className="mt-8 flex gap-3">
								<Dialog.Close className="flex-1 py-3 text-sm font-bold text-gray-500 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors">
									Cancel
								</Dialog.Close>
								<button
									...
									className="flex-[2] py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-xl shadow-lg shadow-blue-200 transition-all disabled:opacity-50 disabled:shadow-none flex items-center justify-center gap-2"
								>
			...
			>
				<Dialog.Portal>
					...
					<Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 z-[90] border border-gray-100">
						<div className="flex items-center gap-3 mb-4">
						...
						<div className="flex gap-3">
							...
							<button
								...
								className="flex-[2] py-3 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-xl shadow-lg shadow-red-200 transition-all disabled:opacity-50 disabled:shadow-none flex items-center justify-center gap-2"
							>
			...
			{addingToOrder && (
				...
				>
					<Dialog.Portal>
						<Dialog.Overlay className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[60]" />
						<Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-2xl shadow-2xl p-6 z-[70] border border-gray-100 flex flex-col max-h-[85vh]">
							<div className="flex items-center justify-between mb-4">
								<div>
									<Dialog.Title className="text-xl font-bold text-gray-900">
										Add Members to Team
									...
									{packerAssignments.filter(
										...
										packerAssignments
											...
											.map((p) => (
												<div
													key={p.packer_id}
													className="flex items-center justify-between p-3 bg-white border border-gray-100 rounded-xl hover:border-blue-200 hover:bg-blue-50/30 transition-all group"
												>
													<div className="flex items-center gap-3">
														<div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold group-hover:bg-blue-100 transition-colors">
															{p.full_name.charAt(0)}
							...
							<div className="mt-6 pt-4 border-t border-gray-100">
								<Dialog.Close className="w-full py-3 text-sm font-bold text-gray-500 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors">
									Done
								</Dialog.Close>
							</div>
						</Dialog.Content>

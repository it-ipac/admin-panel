...
export default function Header() {
	...
	return (
		<>
			<header className="p-4 flex items-center bg-neutral-800 text-white shadow-lg">
				<button
					type="button"
			...
			>
				...
				<nav className="flex-1 p-4 overflow-y-auto">
					<Link
						...
						activeProps={{
							className:
								"flex items-center gap-3 p-3 rounded-lg bg-aqua-600 hover:bg-aqua-700 transition-colors mb-2",
						}}
					>
						<Home size={20} />

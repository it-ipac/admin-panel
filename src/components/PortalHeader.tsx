...
export function PortalHeader({
	...
	return (
		<header className="portal-brand sticky top-0 z-40 border-b border-app-border bg-app-surface/95 shadow-[0_1px_0_rgba(15,23,42,0.04)] backdrop-blur-xl dark:shadow-[0_1px_0_rgba(15,23,42,0.2)]">
			<div
				className={`${maxWidth} mx-auto px-1.5 min-[360px]:px-2 min-[480px]:px-4 sm:px-6 md:px-7 lg:px-8`}
			>
				<div className="flex min-h-16 items-center gap-0.5 py-1 sm:min-h-[4.5rem] min-[360px]:gap-1 min-[480px]:gap-2 sm:gap-3 md:gap-4 sm:py-2">
					<Link
						to="/portal/projects"
					...
					>
						<PortalBrand
							variant="header"
							className="transition-transform duration-200 group-hover:-translate-y-0.5 group-active:translate-y-0 group-active:scale-[0.97] motion-reduce:transform-none motion-reduce:transition-none"
							markClassName="transition-transform duration-200 group-hover:scale-105 motion-reduce:transform-none motion-reduce:transition-none"
						/>
						...
						{user ? (
							<DropdownMenu.Root>
								<DropdownMenu.Trigger asChild>
									<button
										type="button"
										className="group inline-flex h-10 min-h-10 items-center gap-2 rounded-xl border border-neutral-200 bg-white px-1.5 text-sm font-semibold text-neutral-700 shadow-sm transition-[background-color,border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-primary-200 hover:bg-primary-50 hover:shadow-lg hover:shadow-primary-600/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 active:translate-y-0 active:scale-[0.97] motion-reduce:transform-none motion-reduce:transition-none max-[359px]:h-8 max-[359px]:min-h-8 max-[359px]:w-8 max-[359px]:px-0 max-[380px]:h-9 max-[380px]:min-h-9 max-[380px]:w-9 max-[380px]:justify-center max-[380px]:gap-0 max-[380px]:px-0 sm:h-11 sm:min-h-11 sm:px-3 md:h-12 md:min-h-12 dark:border-steel-700 dark:bg-steel-800 dark:text-steel-100 dark:hover:border-primary-800 dark:hover:bg-primary-950/40"
										aria-label="Open account menu"
										title="Account"
									>
										<span className="flex h-7 w-7 items-center justify-center rounded-lg bg-primary-100 text-primary-700 transition-[background-color,transform] duration-200 group-hover:scale-105 group-hover:bg-primary-200 motion-reduce:transform-none motion-reduce:transition-none max-[359px]:h-5 max-[359px]:w-5 max-[380px]:h-6 max-[380px]:w-6 dark:bg-primary-900/40 dark:text-primary-200 dark:group-hover:bg-primary-900/70">
											<UserRound
												className="h-4 w-4 transition-transform duration-200 group-hover:scale-110 motion-reduce:transform-none motion-reduce:transition-none"
												aria-hidden="true"
											/>
